...
#define LOG_TAG "CJGAVComponet.h"
...
/**
 注意：CJGAVLearningDemo中使用CJGAVComponent，因CJGAVComponent内有c++文件
 所以必须在CJGAVLearningDemo->build Phases->link binary with libraries中引入libc++.tbd文件
 */
