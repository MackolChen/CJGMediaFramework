...
@interface CJGAVAssetExportSession ()
{
...
@implementation CJGAVAssetExportSession
{
    NSError *_error;
...
{
    return [CJGAVAssetExportSession.alloc initWithAsset:asset];
}
