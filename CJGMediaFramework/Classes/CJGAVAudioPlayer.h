...
/**
 ...
 2、在@implementation CJGAVAudioPlayer
 写@dynamic delegate;//解决子类协议继承父类协议的delegate命名警告
 
 */
@class CJGAVAudioPlayer;
@protocol CJGAVAudioPlayerDelegate <NSObject,CJGAVPlayCoreBaseDelegate>
...
/**
 ...
 @param player 播放器
 */
- (void)didChangedAudioPlayState:(CJGAVPlayerState)state player:(CJGAVAudioPlayer *)player;
 ...
 */
@interface CJGAVAudioPlayer : CJGAVPlayCoreBase

@property (nonatomic,weak) id<CJGAVAudioPlayerDelegate> delegate;

/**
 methods0：AVAuidoPlayer：详见CJGAVAudioPlayer
