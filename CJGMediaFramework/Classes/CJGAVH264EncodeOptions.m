...
@implementation CJGAVH264EncodeOptions
...
/**
 ...
 @return CJGAVH264EncodeOptions
 */
+ (instancetype)defaultOptions{
    
    CJGAVH264EncodeOptions *options = [CJGAVH264EncodeOptions defaultOptionsForQuality: CJGAVH264VideoQuality_Default];
    return options;
}
...
+ (instancetype)defaultOptionsForQuality:( CJGAVH264VideoQuality)videoQuality{
    ...
    CJGAVH264EncodeOptions *options = [CJGAVH264EncodeOptions defaultOptionsForQuality:videoQuality outputImageOrientation:UIInterfaceOrientationPortrait];
    return options;
}
/**
 视频配置(质量&是否是横屏)
...
+ (instancetype)defaultOptionsForQuality:( CJGAVH264VideoQuality)videoQuality outputImageOrientation:(UIInterfaceOrientation)outputImageOrientation{
    ...
    CJGAVH264EncodeOptions *options = [CJGAVH264EncodeOptions new];
    switch (videoQuality)
    {
        case  CJGAVH264VideoQuality_Low1:
        {
            options.sessionPreset = CJGAVH264CaptureSessionPreset360x640;
            ...
            break;
        case  CJGAVH264VideoQuality_Low2:
        {
            options.sessionPreset = CJGAVH264CaptureSessionPreset360x640;
            ...
            break;
        case  CJGAVH264VideoQuality_Low3:
        {
            options.sessionPreset = CJGAVH264CaptureSessionPreset360x640;
            ...
            break;
        case  CJGAVH264VideoQuality_Medium1:
        {
            options.sessionPreset = CJGAVH264CaptureSessionPreset540x960;
            options.videoFrameRate = 15;
            options.videoBitRate = 800 * 1000;
            options.videoMaxBitRate = 960 * 1000;
            options.videoMinBitRate = 500 * 1000;
            ...
            break;
        case  CJGAVH264VideoQuality_Medium2:
        {
            options.sessionPreset = CJGAVH264CaptureSessionPreset540x960;
            options.videoFrameRate = 20;
            options.videoBitRate = 800 * 1000;
            ...
            break;
        case  CJGAVH264VideoQuality_Medium3:
        {
            options.sessionPreset = CJGAVH264CaptureSessionPreset540x960;
            options.videoFrameRate = 30;
            ...
            break;
        case  CJGAVH264VideoQuality_High1:
        {
            options.sessionPreset = CJGAVH264CaptureSessionPreset720x1280;
            options.videoFrameRate = 15;
            options.videoBitRate = 1000 * 1000;
            options.videoMaxBitRate = 1200 * 1000;
            options.videoMinBitRate = 500 * 1000;
            ...
            break;
        case  CJGAVH264VideoQuality_High2:
        {
            options.sessionPreset = CJGAVH264CaptureSessionPreset720x1280;
            options.videoFrameRate = 20;
            ...
            break;
        case  CJGAVH264VideoQuality_High3:
        {
            options.sessionPreset = CJGAVH264CaptureSessionPreset720x1280;
            options.videoFrameRate = 30;
            options.videoBitRate = 1200 * 1000;
 ...
 */
- (CJGAVH264CaptureSessionPreset)supportSessionPreset:(CJGAVH264CaptureSessionPreset)sessionPreset
{
    ...
    {
        if (sessionPreset == CJGAVH264CaptureSessionPreset720x1280)
        {
            sessionPreset = CJGAVH264CaptureSessionPreset540x960;
            if (![session canSetSessionPreset:self.avSessionPreset])
            {
                sessionPreset = CJGAVH264CaptureSessionPreset360x640;
            }
        } else if (sessionPreset == CJGAVH264CaptureSessionPreset540x960)
        {
            sessionPreset = CJGAVH264CaptureSessionPreset360x640;
        }
    }
...
- (NSString *)avSessionPreset
{
    ...
    {
        case CJGAVH264CaptureSessionPreset360x640:
        {
            avSessionPreset = AVCaptureSessionPreset640x480;
        }
            break;
        case CJGAVH264CaptureSessionPreset540x960:
        {
            avSessionPreset = AVCaptureSessionPresetiFrame960x540;
        }
            break;
        case CJGAVH264CaptureSessionPreset720x1280:
        {
...
/**
 ...
 @param sessionPreset 视频分辨率
 */
- (void)setSessionPreset:( CJGAVH264CaptureSessionPreset)sessionPreset
{
...
- (BOOL)isEqual:(id)other
{
    ...
    {
        CJGAVH264EncodeOptions *object = other;
...
{
    CJGAVH264EncodeOptions *other = [self.class defaultOptions];
    return other;
}
