...
@interface CJGAVAACAudioEncoder ()
{
...
@implementation CJGAVAACAudioEncoder
...
- (void)encodeAudioDataBuffer:(char *)buffer timeStamp:(uint64_t)timeStamp
{
    ...
    //6、设置音频编码信息
    CJGAVAudioRTMPFrame *audioFrame = [[CJGAVAudioRTMPFrame alloc] init];
...
{
    CJGAVAACAudioEncoder *encoder = (__bridge CJGAVAACAudioEncoder *)(inUserData);
