...
NSString *const CJGAudioComponentFailedToCreateNotification = @"CJGAudioComponentFailedToCreateNotification";

@interface CJGAVThreeAudioRecorder ()
...
@implementation CJGAVThreeAudioRecorder
...
- (instancetype)initWithAudioRecordOptions:(CJGAVAudioRecorderOptions *)options{
    if (self = [super initWithAudioRecordOptions:options]) {
        ...
        _audioCaptureTaskQueue = dispatch_queue_create("com.CJGAVComponent.audioCapture.Queue", NULL);
...
{
    @autoreleasepool {
        CJGAVThreeAudioRecorder *recorder = (__bridge CJGAVThreeAudioRecorder *)inRefCon;
...
- (void)handleAudioComponentCreationFailure
{
    dispatch_async(dispatch_get_main_queue(), ^{
        [[NSNotificationCenter defaultCenter] postNotificationName:CJGAudioComponentFailedToCreateNotification object:nil];
    });
}
