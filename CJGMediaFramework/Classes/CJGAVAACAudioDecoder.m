//
//  CJGAVAACAudioDecoder.m
//  CJGAVComponent
//
//  Created by Jinguo Chen on 2022/7/10.
...
@interface CJGAVAACAudioDecoder ()
{
    //表示音频文件对象的不透明数据类型。
...
@implementation CJGAVAACAudioDecoder
...
void inCallbackProc(void *inUserData,AudioQueueRef inAQ,
    ...
    CJGAVAACAudioDecoder *decoder = (__bridge CJGAVAACAudioDecoder *)inUserData;
    if (!decoder) {
        NSLog(@"decoder nil");
        return ;
    }
